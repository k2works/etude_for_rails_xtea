...
CREATE TABLE ORDER_DETAILS(
     ID CHAR(10) NOT NULL COMMENT 'ID',
     ORDERS__NO CHAR(20) NOT NULL COMMENT '受注No',
     ROW__NO CHAR(20) NOT NULL COMMENT '行番号',
     PRODUCTS__CODE CHAR(5) NOT NULL COMMENT '商品コード',
     QUANTITY INTEGER NOT NULL COMMENT '受注数',
     SHIP__DATE DATE NOT NULL COMMENT '出荷日',
CONSTRAINT ORDER_DETAILS_PK PRIMARY KEY (ORDERS__NO, ROW__NO),
CONSTRAINT ORDER_DETAILS_FK1 FOREIGN KEY (PRODUCTS__CODE) REFERENCES PRODUCTS (CODE),
CONSTRAINT ORDER_DETAILS_FK2 FOREIGN KEY (ORDERS__NO) REFERENCES ORDERS (NO)
);
...
CREATE TABLE PRODUCTS(
     ...
     PURCHASE__PRICE INTEGER NOT NULL COMMENT '購入単価',
     SALES__PRICE INTEGER NOT NULL COMMENT '販売単価',
