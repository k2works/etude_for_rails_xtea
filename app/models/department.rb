...
class Department < ApplicationRecord
  ...
  has_many :department_hierarchies, :class_name => 'DepartmentHierarchy', :foreign_key => [:CDBUMON], dependent: :destroy
  has_many :employee_departments, :class_name => 'EmployeeDepartment', :foreign_key => [:CDBUMON], dependent: :destroy
end
